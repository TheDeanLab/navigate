'''
multiscale Waveform Generator - Creates and allows control of waveform generation.
'''
import os
import numpy as np
import csv
...
class multiscale_WaveFormGenerator(QtCore.QObject):
    ...
    def create_tasks(self):
        '''Creates a total of four tasks for the multiscale:
...
class multiscale_DemoWaveFormGenerator(QtCore.QObject):
    '''This class contains the microscope state
