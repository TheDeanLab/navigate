# Image Writer class, intended to run in the Camera Thread and handle file I/O
...
# TODO: distutils has been deprecated in favor of setuptools
...
class ImageWriter():
    def __init__(self, parent=None):
        # Image and metadata writer class.

        super().__init__()
        # self.parent is a Camera() object
        self.parent = parent
        self.cfg = parent.cfg
        self.verbose = True
        ...
        if self.file_extension == '.h5':
            if acq == acq_list[-1]:
                try:
                    ...
                    self.bdv_writer.set_attribute_labels('illumination',
    ...
    def write_line(self, file, key='', value=''):
        # Helper method to write a single line with a key and value for metadata
    ...
    def write_metadata(self, acq, acq_list):
        ...
        # TODO: change to true ETL values
