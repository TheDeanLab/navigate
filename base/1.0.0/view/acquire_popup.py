...
class Acquire_PopUp(ttk.Frame):
    def __init__(acqPop, toplevel,*args, **kwargs):
        #Init popup with toplevel class(new window in tk)
        ttk.Frame.__init__(acqPop, toplevel,*args, **kwargs)

        #This starts the popup window config, and makes sure that any child widgets can be resized with the window
        acqPop.toplevel = toplevel
        ...
        acqPop.toplevel.protocol("WM_DELETE_WINDOW", dismiss) #Intercepting close button
        ...
        #Creating a frame to hold content, and putting it into popup

        #
        acqPop.content = ttk.Frame(acqPop) #TODO need this debugged getting a bad window path name here
        #
        ...
        content = acqPop.content
        #Label for entries
        content.entries_label = ttk.Label(acqPop.content, text="Please fill out the fields below")

        
        #User Entry
        content.user_entry_frame = ttk.Frame(acqPop.content)
        ...
        #Tissue Entry
        content.tissue_entry_frame = ttk.Frame(acqPop.content)
        ...
        #Cell Type Entry
        content.celltype_entry_frame = ttk.Frame(acqPop.content)
        ...
        #Label Entry
        content.label_entry_frame = ttk.Frame(acqPop.content)
        ...
        #Cell Number Entry
        content.cellnum_entry_frame = ttk.Frame(acqPop.content)
        ...
        content.date_entry_frame = ttk.Frame(acqPop.content)
