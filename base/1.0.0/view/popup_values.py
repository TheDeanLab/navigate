...
##TODO goal of this class is to create a generic content class but may not be possible otherwise this will be used
# to create the startup dialog to let the user select what configs they want from the config file ie synthetic or not

#Handles populating the window with entries etc
class popup_values(ttk.Frame):
    ...
    def __init__(self, popup, *args, **kwargs):
        ...
        #Label for entries
        self.entries_label = ttk.Label(self, text="Please select options below")
