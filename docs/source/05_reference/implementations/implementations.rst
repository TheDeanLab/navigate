...
Central to its operation, the specimen is precisely positioned at the intersection of both imaging modules using high-precision translation and rotation stages that offer extensive travel distances (approximately 50-200 mm). This configuration enables rapid switching between macroscale and nanoscale imaging modes. The MCT-ASLM is adept at quickly producing detailed scans of large cleared tissues (up to 21.1 x 21.1 x 20 mm in size) at a resolution of 2.4 and 4.2 microns in XY and Z, respectively. Furthermore, it integrates advanced computer vision techniques to automatically identify biological features of interest and allows for detailed analysis with a resolution of 380 and 333 nm in XY and Z, respectively.

A publication describing the MCT-ASLM system is currently under review. In this manuscript, we outline multiple modes of operation, including:

- :ref:`Human-in-the-loop <human_in_the_loop>` operation, where the user interactively selects multiple features that are then automatically imaged at high resolution.
- :ref:`Automatic tiling <smart_tiling>`, where the system automatically identifies regions of interest and images them at high resolution.
- :ref:`Feature-driven imaging <smart_object_detection>`, where the system automatically identifies regions of interest in a large 3D volume and images them at high resolution.
...
* `Benchtop mesoSPIM: a next-generation open-source light-sheet microscope for cleared samples  <https://www.nature.com/articles/s41467-024-46770-2>`_
* `The mesoSPIM initiative: open-source light-sheet microscopes for imaging cleared tissue <https://www.nature.com/articles/s41592-019-0554-0>`_
