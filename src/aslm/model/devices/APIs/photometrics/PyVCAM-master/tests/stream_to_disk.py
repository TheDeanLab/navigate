...
def main():
    ...
    while True:
        ...
        if frame_count >= NUM_FRAMES:
            ...
            print(
                "Min:{}\tMax:{}\tAverage:{:.0f}\tFrame Count:{:.0f} Frame Rate: {:.1f}".format(
                    low, high, average, frame_count, fps
                )
            )
            break
    ...
    framePad = (
        ...
        else FRAME_ALIGNMENT - (bytesPerFrameUnpadded % FRAME_ALIGNMENT)
    )
    ...
    with open(FRAME_DATA_PATH, "rb") as f:
        ...
        for frame_index in range(NUM_FRAMES):
            ...
            frameBufferPad = (
                int(frame_index / BUFFER_FRAME_COUNT) * frameBufferAlignmentPad
            )
