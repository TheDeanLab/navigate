...
def get_dummy_model():
    """
    Creates a dummy model to be used for testing.
    All hardware is synthetic and the current config settings are loaded.
    """
    ...
    # This return is used when you want a full synthetic model instead of just variable data from config files
