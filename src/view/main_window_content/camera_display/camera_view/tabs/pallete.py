...
class pallete(ttk.Frame):
    def __init__(self, cam_view, *args, **kwargs):
        ...
        self.gray = ttk.Radiobutton(self.pallete, text="Gray", variable=self.color, value='gray')
        self.gray.invoke()
        self.gradient = ttk.Radiobutton(self.pallete, text="Gradient", variable=self.color, value='hot')
        self.rainbow = ttk.Radiobutton(self.pallete, text="Rainbow", variable=self.color, value='viridis')
