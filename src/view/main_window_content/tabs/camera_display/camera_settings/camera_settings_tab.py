...
import numpy as np
from view.main_window_content.tabs.camera_display.camera_settings.camera_roi import camera_mode_label_frame, camera_roi_label_frame, camera_mode_label_frame
